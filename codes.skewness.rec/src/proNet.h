...
class proNet {
    ...
    public:
        ...
        vector< ContextContext > contextcontext;
        ...
        // vertex representation, context representation, margin, alpha, vertex loss, context loss, alpha
        void Opt_BPRSGD(vector<double>&, vector<double>&, double, double, vector<double>&, vector<double>&);
        //
        int Opt_FBPRSGD(vector<double>&, vector<double>&, double, vector<double>&, vector<double>&, double, double);
        ...
        // vertex vector, context vector, vertex, context, dimension, negative samples, margin, alpha
        void UpdateBPRPair(vector< vector<double> >&, vector< vector<double> >&, long, long, long, int, double, double, double);
        // vertex vector, context vector, vertex, context, dimension, negative samples, alpha
        void UpdateWARPPair(vector< vector<double> >&, vector< vector<double> >&, long, long, long, int, double);
        void UpdateWARPPairF(vector< vector<double> >&, vector< vector<double> >&, long, long, long, int, double, double);
        ...
        // vertex vector, context vector, vertex, context, dimension, negative samples, margin, mu
        void UpdateFBPRPair(vector< vector<double> >&, vector< vector<double> >&, long, long, long, int, double, double, double);
        ...
        //
        void UpdateCBOWdev(vector< vector<double> >&, vector< vector<double> >&, vector< vector<double> >&, long, long, int, double, int, int, double);
        void UpdateFCBOW(vector< vector<double> >&, vector< vector<double> >&, vector< vector<double> >&, vector< vector<double> >&, long, long, int, double, int, double);
        ...
        void UpdateSampledGCN(vector< vector<double> >&, vector< vector<double> >&, long, long, int, double, int, int, double);
