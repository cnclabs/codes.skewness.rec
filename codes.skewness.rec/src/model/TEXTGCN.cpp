...
void TEXTGCN::SaveWeights(string model_name){
...
void TEXTGCN::LoadFieldMeta(string filename) {
    pnet.LoadFieldMeta(filename);
}

void TEXTGCN::Train(int sample_times, int walk_steps, int negative_samples, double reg, double alpha, int workers){
